...
INSERT INTO taxcategories(id, name) VALUES ('000', 'Imp Excento');
INSERT INTO taxcategories(id, name) VALUES ('001', 'Imp Estandar');
INSERT INTO taxcategories(id, name) VALUES ('002', 'Imp Otros');

-- ADD TAXES
/* 002 added 31/01/2017 00:00:00. */
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('000', 'Imp Excento', '000', NULL, NULL, 0, FALSE, NULL);
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('001', 'Imp Estandar', '001', NULL, NULL, 0.20, FALSE, NULL);
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('002', 'Imp Otros', '002', NULL, NULL, 0, FALSE, NULL);
...
-- ADD LOCATION
INSERT INTO locations(id, name, address) VALUES ('0','Local 1','Local');

-- ADD SUPPLIERS
INSERT INTO suppliers(id, searchkey, name) VALUES ('0','SmartPos','smartpos');

-- ADD UOM
INSERT INTO uom(id, name) VALUES ('0','Cada');

-- ADD FLOORS
INSERT INTO floors(id, name, image) VALUES ('0', 'Piso de restaurante', $FILE{/com/openbravo/pos/templates/restaurant_floor.png});
...
-- ADD BREAKS
INSERT INTO breaks(id, name, visible, notes) VALUES ('0', 'Pausa Almuerzo', TRUE, NULL);
INSERT INTO breaks(id, name, visible, notes) VALUES ('1', 'Pausa Mediasnueves', TRUE, NULL);
INSERT INTO breaks(id, name, visible, notes) VALUES ('2', 'Pausa Onces', TRUE, NULL);

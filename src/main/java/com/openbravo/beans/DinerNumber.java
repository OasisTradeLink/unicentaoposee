...
//    Copyright (c) 2017 Alejandro Camargo - joint with Jacinto Rodriguez
//    https://unicenta.com
//
 ...
 */
public class DinerNumber extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DinerNumber(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        init();
    }
     ...
     * @param parent
     * @param modal */
    public DinerNumber(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        init();
    }

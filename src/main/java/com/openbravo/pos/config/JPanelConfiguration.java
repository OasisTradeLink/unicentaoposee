...
public class JPanelConfiguration extends JPanel implements JPanelView {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Lenguaje", jPanelLocale);
        ...
        jTabbedPane1.addTab("Metodo de Pago", jPanelPayment);
        ...
        jTabbedPane1.addTab("Conf. Recibo", jPanelTicketSetup);
        ...
        jTabbedPane1.addTab("Conf. Base de Datos", jPanelDatabase);
